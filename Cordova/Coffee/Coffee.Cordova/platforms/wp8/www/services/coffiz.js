  ...
  .factory('coffeeShopSvc', ['$http', function($http) {
    ...
    public_.simplified = function(cafedata) {
      return {
        ...
        position : cafedata.fields.geo_latitude,
    ...
    public_.getCoffeeShops = function () {
      return $http.get('http://opendata.paris.fr/api/records/1.0/search?dataset=liste-des-cafes-a-un-euro&rows=50&facet=arrondissement&facet=nom_du_cafe&facet=geo_latitude&facet=adresse');
    }
